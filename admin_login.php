  ...
  <div class="wrapper">
    ...
    <form action="admin_login.php" method='post'>
      ...
      <div class="row">
        ...
        <input type="password" placeholder="Password" required name='pas' />
      </div>
      <div class="row button">
        <input type="submit" value="Login" name='login' />
      </div>
      <div class="signup-link">Not registered? <a href="admin_signup.php">Signup now</a></div>
    </form>
  </div>
</body>
</html>
...
$vpas=FALSE;
//hasing data
$hsql="SELECT `pas` FROM `admin` WHERE `email`='$user' ";
